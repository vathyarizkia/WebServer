...
const char* ssid = "EYRO"; // your connection name
const char* password = "eyro1234"; // your connection password

ESP8266WebServer server(80);

int gpio1_pin = 0;  // D4 of nodemcu
int gpio2_pin = 14; // D5 of nodemcu
